...
public class ClothStoreV extends JFrame{
	...
	public ClothStoreV() {
		...
		clotharr[0] = new ClothStoreM("∆Ì«—ø ", 10, '1');
		clotharr[1] = new ClothStoreM("ø‹√‚∫π", 10, '2');
		clotharr[2] = new ClothStoreM("√º≈©µÂ∑πΩ∫", 10, '3');
		clotharr[3] = new ClothStoreM("∏È¡¢∫π¿Â", 10, '4');
		clotharr[4] = new ClothStoreM("ªÛ≈≠πﬂ∂ˆ", 10, '5');
